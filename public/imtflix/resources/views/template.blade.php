...
<body>
	...
	<section class="shop-banner">
    	<div class="container">
        	<h3>Les Films de Noêl Arrive! <br> Trés bientôt <span class="orange-text">Restez Connecter...</span></h3>
            <div class="sale-percent"><span>BlackFriday! <br> Nouveaux membres? </span>50% <span>Inscrivez vous</span></div>
            <a href="inscription.html" class="cart-btn btn-lg">S'inscrire</a>
        </div>
    </section>
	<!-- end shop banner -->
